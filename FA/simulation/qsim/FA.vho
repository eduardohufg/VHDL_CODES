...
-- Design Ports Information
-- s	=>  Location: PIN_T6,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- Cout	=>  Location: PIN_P3,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL \HA1|s~0_combout\ : std_logic;
...
\HA1|s~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \HA1|s~0_combout\ = \a~input_o\ $ (\b~input_o\ $ (\Cin~input_o\))
