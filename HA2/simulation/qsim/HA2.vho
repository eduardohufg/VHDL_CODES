...
-- Cout	=>  Location: PIN_W6,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- a	=>  Location: PIN_Y1,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- b	=>  Location: PIN_U6,	 I/O Standard: 2.5 V,	 Current Strength: Default


ARCHITECTURE structure OF HA2 IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
